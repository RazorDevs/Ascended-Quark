...
public class AmbrosiumLampModule extends ZetaModule {
	...
	public void register(ZRegister register) {
		RegistryUtil.addCreativeModeTab(AetherCreativeTabs.AETHER_FUNCTIONAL_BLOCKS.getKey(),
				new AmbrosiumLampBlock("ambrosium_lamp", this,
						BlockBehaviour.Properties.of().mapColor(MapColor.WOOL).instrument(NoteBlockInstrument.BASEDRUM)
								...
								.lightLevel((blockState) -> AmbrosiumLampBlock.getScaledChargeLevel(blockState, 16))),
				AetherBlocks.AMBROSIUM_TORCH, this);
	}
}
