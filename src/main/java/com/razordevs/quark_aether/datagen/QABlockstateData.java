...
public class QABlockstateData extends BlockStateProvider {
    public QABlockstateData(DataGenerator output, ExistingFileHelper helper) {
        super(output, QuarkAetherMod.MODID, helper);
    }

    @Override
    public void registerStatesAndModels() {
        this.block(QABlocks.AETHER_COARSE_DIRT.get());
    }
