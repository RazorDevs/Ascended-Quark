...
public abstract class AQEntityInABucketItem extends ZetaItem {
    ...
    public AQEntityInABucketItem(String regname, @Nullable ZetaModule module, Properties properties, DeferredHolder<EntityType<?>, ? extends EntityType<? extends Slime>> bucketEntity) {
        super(regname, module, properties.stacksTo(1));
        this.bucketEntityHolder = bucketEntity;
        this.bucketEntity = null;
    }

    public AQEntityInABucketItem(String regname, @Nullable ZetaModule module, Properties properties, EntityType<? extends Slime> bucketEntity) {
        super(regname, module, properties.stacksTo(1));
