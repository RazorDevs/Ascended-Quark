...
public class AQRecipeData extends RecipeProvider {
    ...
    protected void woodset(String type, Block planks, Block log, Block wood, Block strippedWood, Block leaves, Block slab, String flag, Consumer<FinishedRecipe> consumer) {
    ...
    protected void carpet(ItemLike carpet, ItemLike leaf, String flag, Consumer<FinishedRecipe> consumer) {
    ...
    protected void hedge(ItemLike hedge, ItemLike leaves, ItemLike stem, ResourceLocation conditionLocation, String conditionName, Consumer<FinishedRecipe> consumer) {
