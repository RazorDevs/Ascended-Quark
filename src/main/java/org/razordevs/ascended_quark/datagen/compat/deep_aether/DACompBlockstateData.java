...
public class DACompBlockstateData extends AQBlockstateData {
	...
	public void registerStatesAndModels() {
		this.woodset("roseroot", DABlocks.ROSEROOT_LOG.get(), DABlocks.STRIPPED_ROSEROOT_LOG.get(),
				DABlocks.ROSEROOT_PLANKS.get(), DABlocks.ROSEROOT_LEAVES.get());
		...
		this.hedge("flowering_blue_roseroot", DABlocks.FLOWERING_BLUE_ROSEROOT_LEAVES.get(),
				DABlocks.ROSEROOT_LOG.get());
		this.hedge("flowering_roseroot", DABlocks.FLOWERING_ROSEROOT_LEAVES.get(), DABlocks.ROSEROOT_LOG.get());

		this.woodset("cruderoot", DABlocks.CRUDEROOT_LOG.get(), DABlocks.STRIPPED_CRUDEROOT_LOG.get(),
				DABlocks.CRUDEROOT_PLANKS.get(), DABlocks.CRUDEROOT_LEAVES.get());
		this.woodset("sunroot", DABlocks.SUNROOT_LOG.get(), DABlocks.STRIPPED_SUNROOT_LOG.get(),
				DABlocks.SUNROOT_PLANKS.get(), DABlocks.SUNROOT_LEAVES.get());
		this.woodset("yagroot", DABlocks.YAGROOT_LOG.get(), DABlocks.STRIPPED_YAGROOT_LOG.get(),
				DABlocks.YAGROOT_PLANKS.get(), DABlocks.YAGROOT_LEAVES.get());
		this.woodset("conberry", DABlocks.CONBERRY_LOG.get(), DABlocks.STRIPPED_CONBERRY_LOG.get(),
				DABlocks.CONBERRY_PLANKS.get(), DABlocks.CONBERRY_LEAVES.get());
