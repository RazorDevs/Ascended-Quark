...
public class AQItemTagData extends AQItemTagProvider {
	public AQItemTagData(PackOutput p_275343_, CompletableFuture<HolderLookup.Provider> p_275729_,
	...
	protected void addTags(HolderLookup.Provider provider) {
		tag(ItemTags.create(ResourceLocation.fromNamespaceAndPath(Quark.MOD_ID, "stools")))
				.add(blockMap.get("skyroot_stool").asItem());

		tag(ItemTags.ARROWS).add(itemMap.get("ambrosium_torch_arrow"));
