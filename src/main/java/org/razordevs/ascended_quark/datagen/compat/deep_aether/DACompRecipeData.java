...
public class DACompRecipeData extends AQRecipeData {
	...
	protected void buildRecipes(RecipeOutput consumer) {
		woodset("roseroot", DABlocks.ROSEROOT_PLANKS.get(), DABlocks.ROSEROOT_LOG.get(), DABlocks.ROSEROOT_WOOD.get(),
				...
				DA_WOOD, consumer);
		this.hedge(aqBlocks.get("flowering_roseroot_hedge"), DABlocks.FLOWERING_ROSEROOT_LEAVES.get(),
				DABlocks.ROSEROOT_LOG.get(), DA_WOOD, consumer);
		this.hedge(aqBlocks.get("blue_roseroot_hedge"), DABlocks.BLUE_ROSEROOT_LEAVES.get(),
				DABlocks.ROSEROOT_LOG.get(), DA_WOOD, consumer);
		this.hedge(aqBlocks.get("flowering_blue_roseroot_hedge"), DABlocks.FLOWERING_BLUE_ROSEROOT_LEAVES.get(),
				DABlocks.ROSEROOT_LOG.get(), DA_WOOD, consumer);
		this.carpet(aqBlocks.get("flowering_roseroot_leaf_carpet"), DABlocks.FLOWERING_ROSEROOT_LEAVES.get(), DA_WOOD,
				consumer);
		this.carpet(aqBlocks.get("blue_roseroot_leaf_carpet"), DABlocks.BLUE_ROSEROOT_LEAVES.get(), DA_WOOD, consumer);
		this.carpet(aqBlocks.get("flowering_blue_roseroot_leaf_carpet"), DABlocks.FLOWERING_BLUE_ROSEROOT_LEAVES.get(),
				DA_WOOD, consumer);
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, aqBlocks.get("aether_mud_pillar"))
				...
				.save(consumer.withConditions(zetaFlag("more_mud_blocks"), zetaFlag("more_aether_mud_blocks")));
		...
		stonecuttingRecipe(aqBlocks.get("aether_mud_pillar"), DABlocks.AETHER_MUD_BRICKS.get(), consumer,
				zetaFlag("more_mud_blocks"), zetaFlag("more_aether_mud_blocks"));
	}
}
