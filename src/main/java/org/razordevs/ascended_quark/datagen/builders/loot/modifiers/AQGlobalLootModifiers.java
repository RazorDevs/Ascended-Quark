...
public class AQGlobalLootModifiers {
    ...
    public static DeferredHolder<?, ? extends MapCodec<? extends IGlobalLootModifier>> AETHER_DUNGEON_LOOT_CODEC = LOOT_MODIFIERS.register("pickarang_aether_dungeon_loot", AQDungeonLootModifier.CODEC);
